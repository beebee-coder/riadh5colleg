// src/lib/data.ts
// TEMPORARY DATA - No type imports from main app to avoid circular dependencies

type Role = "student" | "admin" | "teacher" | "parent" | "agent_administratif";

export let role: Role = "student";
